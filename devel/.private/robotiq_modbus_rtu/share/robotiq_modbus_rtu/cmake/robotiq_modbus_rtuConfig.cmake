...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/rosie2/Rosie2.0/src/robotiq/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/rosie2/Rosie2.0/devel/.private/robotiq_modbus_rtu)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/rosie2/Rosie2.0/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosie2/Rosie2.0/src/robotiq/robotiq_modbus_rtu/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rosie2/Rosie2.0/devel/.private/robotiq_modbus_rtu/lib;/home/rosie2/Rosie2.0/devel/lib;/home/rosie2/iiwa_stack_ws/devel/lib;/opt/ros/melodic/lib)
