...
pub = rospy.Publisher('google_transcript', String, queue_size=10, latch=True)
rospy.init_node('GoogleTranscript', anonymous=True)
    ...
    def assist(self):
        ...
        for resp in self.assistant.Assist(iter_log_assist_requests(),
            ...
            if resp.speech_results:
                ...
                """ *************** Added by Gp ****************************************** 
                Fixed how u constract hello-str"""
                trasnscript_str = ' '.join(r.transcript
                                      for r in resp.speech_results)
                pub.publish(trasnscript_str)
                """ *************** End by Gp ****************************************** """
...
def main(api_endpoint, credentials, project_id,
    ...
    """
    """ **************************** Added by GP ***************************************** """
    # loggin has been replaced by logger (rospy logger) due to ROS bug
